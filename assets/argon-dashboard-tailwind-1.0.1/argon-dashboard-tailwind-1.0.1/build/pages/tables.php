              ...
              <div class="px-6 mt-4 mb-4">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div class="flex w-full items-center gap-3">
                    ...
                    <input id="search-recette" type="text" placeholder="Rechercher une recette..." class="flex-1 rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm text-slate-700 outline-none transition duration-200 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-100" />
                    <a href="recette-form.php" class="inline-flex items-center rounded-full bg-emerald-500 px-4 py-2 text-sm font-semibold text-white shadow-md transition hover:bg-emerald-600">
                      + Ajouter
                    </a>
                  </div>
                        ...
                        <tr>
                          ...
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                            <div class="flex justify-center gap-2">
                              <a href="recette-form.php?id=<?= urlencode($recette['id']) ?>" class="inline-flex items-center justify-center rounded-full bg-slate-900 px-3 py-2 text-xs font-semibold text-white hover:bg-slate-700">✏️</a>
                              <a href="/recette/controller/RecetteController.php?delete=<?= urlencode($recette['id']) ?>" class="inline-flex items-center justify-center rounded-full bg-red-500 px-3 py-2 text-xs font-semibold text-white hover:bg-red-600" onclick="return confirm('Voulez-vous supprimer cette recette ?');">❌</a>
                            </div>
                          </td>
                        </tr>
                      <?php endforeach; ?>
