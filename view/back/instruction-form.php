...
$imageValue = $fiche['image'] ?? ($recette['image'] ?? '/2int/public/image/salade.jpg');
      ...
      <div class="w-full px-10 py-10 mx-auto">
        ...
        <div class="overflow-hidden rounded-3xl border border-slate-200/80 bg-white/90 shadow-2xl shadow-slate-200/50 ring-1 ring-white/60 backdrop-blur-md">
          ...
          <div class="p-6 sm:p-8">
            ...
            <?php if (!$id || $fiche) : ?>
            <form id="instruction-form" action="../../controller/InstructionController.php" method="post" class="space-y-8" novalidate>
